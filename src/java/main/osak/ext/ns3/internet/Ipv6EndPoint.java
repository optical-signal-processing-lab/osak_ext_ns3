 ...
 * @since   1.0
 */
public class Ipv6EndPoint {
    /**
     * @brief Constructor.
     * @param address the IPv4 address
     * @param port    the port
     */
    public Ipv6EndPoint(Ipv6Address address, short port) {
	m_localAddr = address;
	m_localPort = port;
     ...
     */
    public Ipv6Address GetLocalAddress() {
	return m_localAddr;
    }
     ...
     */
    public void SetLocalAddress(Ipv6Address address) {
	m_localAddr = address;
    }
     ...
     */
    public void SetLocalPort(short port) {
	m_localPort = port;
    }
     ...
     */
    public void SetPeer(Ipv6Address address, short port) {
	m_peerAddr = address;
	m_peerPort = port;
    }
     ...
     */
    public void SetRxCallback(Callback4<Packet, Ipv6Header, Short, Ipv6Interface> callback) {
     ...
     * @param callback callback function
     */
    public void SetIcmpCallback(Callback5<Ipv6Address, Byte, Byte, Byte, Integer> callback) {
     ...
     */
    public void ForwardUp(Packet p, final Ipv6Header header, short sport, Ipv6Interface incomingInterface) {
     ...
     */
    public void ForwardIcmp(Ipv6Address icmpSource, byte icmpTtl, byte icmpType, byte icmpCode, int icmpInfo) {
     ...
     */
    private Ipv6Address m_localAddr = new Ipv6Address();
     ...
     */
    private Ipv6Address m_peerAddr = new Ipv6Address();
     ...
     */
    private Callback4<Packet, Ipv6Header, Short, Ipv6Interface> m_rxCallback = null;

    /**
     * @brief The ICMPv6 callback.
     */
    private Callback5<Ipv6Address, Byte, Byte, Byte, Integer> m_icmpCallback = null;
